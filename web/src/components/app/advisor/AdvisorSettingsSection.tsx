...
export default function AdvisorSettingsSection({ canManage }: { canManage: boolean }) {
    ...
    return (
        <Section
            eyebrow="Advisor"
            description="Fullpilot checks your sending continuously and surfaces what to fix on the page where the fix lives. Detection runs on your own data with fixed thresholds; AI only rewrites the explanation, and never spends credits."
        >
            <ToggleRow
