...
func seedUnibox(ctx context.Context, pool *pgxpool.Pool, _ *Result) error {
	...
	rows := []seededUniboxEmail{
		...
		},
		{
			...
			threadID: "seed-thread-owner-welcome", messageID: "<seed-owner-welcome@fullpilot.local>",
			uid: 401, flags: []string{}, from: []string{"Fullpilot <team@fullpilot.com>"},
			to: []string{"Owner Inbox <owner@fullpilot.local>"}, subject: "Welcome to Fullpilot",
		...
		},
		{
			...
			threadID: "seed-thread-owner-digest", messageID: "<seed-owner-digest@fullpilot.local>",
			uid: 402, flags: []string{"\\Seen"}, from: []string{"Fullpilot Digest <team@fullpilot.com>"},
			to: []string{"Owner Inbox <owner@fullpilot.local>"}, subject: "Your weekly deliverability digest",
