...
var (
	...
	ErrRegistrationInviteOnly = NewWithIdentifier(Forbidden, "registration_invite_only",
		"This server is invite only. Ask an administrator to invite you, then open the link in the invitation to create your account. See https://www.fullpilot.com")
	...
	ErrRegistrationClosed = NewWithIdentifier(Forbidden, "registration_closed",
		"This server is not accepting new accounts. See https://www.fullpilot.com")
	...
	ErrEmailReauthCloudManaged   = New(Conflict, "Fullpilot Cloud holds this mailbox's sign-in. Reconnect it from your cloud workspace instead.")
