...
func Catalog() []models.IntegrationCatalogEntry {
	return []models.IntegrationCatalogEntry{
		...
		// Automation --------------------------------------------------------
		{
			...
			Highlights:  []string{"Authenticate Zapier with a scoped Fullpilot API key", "Fan events to a Zap webhook URL"},
			Events:      notifyEvents,
		...
		},
		{
			...
			Highlights:  []string{"Authenticate Make with a scoped Fullpilot API key", "Fan events to a Make webhook URL"},
			Events:      notifyEvents,
			ActionTypes: []string{string(models.IntegrationActionGenericWebhookPing)},
		},
		{
			...
			Highlights:  []string{"Authenticate n8n with a scoped Fullpilot API key", "Fan events to an n8n webhook URL"},
			Events:      notifyEvents,
			ActionTypes: []string{string(models.IntegrationActionGenericWebhookPing)},
		},
