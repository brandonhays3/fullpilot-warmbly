...
func seedReplyTemplates(ctx context.Context, pool *pgxpool.Pool) error {
	tpls := []struct {
		...
		{tplBookCall, "Book a call", "Re: {{originalSubject}}",
			"<p>Happy to walk you through it. Here is my calendar: https://fullpilot.com/book</p>",
			"Happy to walk you through it. Here is my calendar: https://fullpilot.com/book", 1},
