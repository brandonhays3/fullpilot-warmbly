...
Even with reply notifications off you never miss anything: every reply still lands in the [Unified Inbox](/guides/unibox/). The notification is only an optional ping.
</Callout>
