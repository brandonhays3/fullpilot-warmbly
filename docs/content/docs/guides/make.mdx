...
Triggers poll on your scenario's schedule. Make remembers what it has seen, so a scenario runs once per new item. New or Updated Contact re-runs on change, because its dedupe key combines contact id with update time. New Email Received needs the Unified Inbox feature, part of an active trial or paid plan.
