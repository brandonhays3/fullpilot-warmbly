...
- **Book a call** on contact detail and Unified Inbox threads opens your page in a new tab, prefilled with the contact's email and name, offering a picker if several links are connected.
- **Booking link** in the [Unified Inbox](/guides/unibox/) composer drops the prefilled link into your reply.
