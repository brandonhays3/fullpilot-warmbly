...
The Warmbly API lets you drive everything you can do in the dashboard programmatically: mailboxes, campaigns, contacts, the unified inbox, and more. It is a JSON API over HTTPS.
